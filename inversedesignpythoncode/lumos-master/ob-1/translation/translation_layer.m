...
%   terms.
% * |solver| is a function handle which (asynchronously异步的) produces the 
...
function [opt_prob, J, E_out] = translate_mode(mode, solver)
    ...
    % Nested function嵌套函数 instead of anonymous function匿名函数, for efficiency.
