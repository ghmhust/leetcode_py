%% maxwell_matrices
% Create the relevant相关的 matrices used in the FDFD method, which Maxwell implements.
...
%% Output parameters
% * |A1, A2] are sparse matrices 稀疏矩阵representing the curl operators旋度操作 in the electromagnetic wave equation, while
...
%% Source code
    ...
    % spdiags返回带状稀疏矩阵A，blkdiag生成指定对角线元素的矩阵
    
    % Get the relevant derivative matrices.得到有关导数矩阵
